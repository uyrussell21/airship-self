...
const WhyAirshipItem = ({ i, title, lead, quote, src }) => (
  <div>
    <img src={`/home/home-feat-${i + 1}.png`} alt={`Feature ${i + 1} graphic`}/>
    <div>
      <h3>{title}</h3>
      <p>{lead}</p>
      <figure>
...
const WhyAirship = () => (
  <section>
    ...
    <picture>
      <source media="(min-width: 992px)" srcset="/home/home-journey.png" />
      <img src="/home/home-journey-sm.png" alt="Path showing different stages of Airship" />
    </picture>

    <div className="body-list">
      {content.map(({ title, lead, quote, src}, i) => (
        <WhyAirshipItem {...{i, title, lead, quote, src}} key={i} />
      ))}
    </div>
  </section>
)
